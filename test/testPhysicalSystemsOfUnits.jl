...
include("../src/PhysicalSystemsOfUnits.jl")
...
const CGS_ENERGY_DENSITY  = PhysicalSystemsOfUnits.CGS_ENERGY_DENSITY
const CGS_ENTROPY         = PhysicalSystemsOfUnits.CGS_ENTROPY
const CGS_ENTROPY_DENSITY = PhysicalSystemsOfUnits.CGS_ENTROPY_DENSITY
...
const CGS_MASS_DENSITY    = PhysicalSystemsOfUnits.CGS_MASS_DENSITY
const CGS_MODULUS         = PhysicalSystemsOfUnits.CGS_MODULUS
const CGS_POWER           = PhysicalSystemsOfUnits.CGS_POWER
const CGS_POWER_DENSITY   = PhysicalSystemsOfUnits.CGS_POWER_DENSITY
...
const SI_ENERGY_DENSITY   = PhysicalSystemsOfUnits.SI_ENERGY_DENSITY
const SI_ENTROPY          = PhysicalSystemsOfUnits.SI_ENTROPY
const SI_ENTROPY_DENSITY  = PhysicalSystemsOfUnits.SI_ENTROPY_DENSITY
...
const SI_MASS_DENSITY     = PhysicalSystemsOfUnits.SI_MASS_DENSITY
const SI_MODULUS          = PhysicalSystemsOfUnits.SI_MODULUS
const SI_POWER            = PhysicalSystemsOfUnits.SI_POWER
const SI_POWER_DENSITY    = PhysicalSystemsOfUnits.SI_POWER_DENSITY
...
function run()
    ...
    println("   entropy density: ", toString(CGS_ENTROPY_DENSITY))
    println("   energy:          ", toString(CGS_ENERGY))
    println("   energy density:  ", toString(CGS_ENERGY_DENSITY))
    println("   power:           ", toString(CGS_POWER))
    println("   power density:   ", toString(CGS_POWER_DENSITY))
    ...
    println("   entropy density: ", toString(SI_ENTROPY_DENSITY))
    println("   energy:          ", toString(SI_ENERGY))
    println("   energy density:  ", toString(SI_ENERGY_DENSITY))
    println("   power:           ", toString(SI_POWER))
    println("   power density:   ", toString(SI_POWER_DENSITY))
